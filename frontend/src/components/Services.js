            ...
            <div class="col-md-4 col-sm-6 equal-height">
              <div class="item">
                <i class="fas fa-pen-fancy">
                  <img src={Fast_Booking} alt="" className="icon-image" style={{height:"80px",width:"80px"}} />
                </i>
            ...
            <div class="col-md-4 col-sm-6 equal-height">
              <div class="item">
                <i class="fas fa-dharmachakra">
                  <img src={Map} alt="" className="icon-image" style={{height:"80px",width:"80px"}} />
                  {/* <img
                        src={img}
                        className="img-fluid"
            ...
            <div class="col-md-4 col-sm-6 equal-height">
              <div class="item">
                <i class="fas fa-tasks">
                  <img src={Pay} alt="" className="icon-image" style={{height:"80px",width:"80px"}}/>
                </i>
            ...
            <div class="col-md-4 col-sm-6 equal-height">
              <div class="item">
                <i class="fas fa-tachometer-alt">
                  <img src={Collection} alt="" className="icon-image" style={{height:"80px",width:"80px"}} />
                </i>
            ...
            <div class="col-md-4 col-sm-6 equal-height">
              <div class="item">
                <i class="fas fa-recycle">
                  <img src={Insurance} alt="" className="icon-image" style={{height:"80px",width:"80px"}} />
                </i>
                <h4>Fully Insured</h4>
                <p>
                  Lorem Ipsum is simply dummy text of the printing and
            ...
            <div class="col-md-4 col-sm-6 equal-height">
              <div class="item">
                <i class="fas fa-headset">
                  <img src={Support} alt="" className="icon-image" style={{height:"80px",width:"80px"}} />
                </i>
                <h4>24/7 Support</h4>
                <p>
                  Lorem Ipsum is simply dummy text of the printing and
